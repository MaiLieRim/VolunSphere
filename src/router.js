...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/task-search', name: 'tasksearch', component: TaskSearch },
    ...
    { path: '/task/:itemId', name: 'task', component: TaskDetails, props: true },
    ...
    { path: '/orgDetail/:organisationId', name: 'orgDetail', component: OrganisationDetail, props: true },
